...
parser.add_argument("-n", "--number", action="store_const", const=ITER_NUM, help=f"Number of iterations to run the simulation for. Default is {ITER_NUM}.")
parser.add_argument("-s", "--size", action="store_cost", const=SIZE, help=f"Size of the conveyor belt. Default is {SIZE}.")
...
print(f"Number of finished produced in {args.number} ticks: {result[Belt.FINISHED]}")
